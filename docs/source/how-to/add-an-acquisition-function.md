...
(alongside the built-in Greedy, UCB, Expected Improvement, Thompson Sampling, CoreSet,
...
1. Subclass {py:class}`AcquisitionFunction <alf_core.optimizer.acquisition_function.AcquisitionFunction>` under `tools/alf_tools/optimizer/acquisition_functions/`.
...
- [Acquisition functions](https://github.com/instadeepai/alf/blob/main/tutorials/extending_base_classes/acquisition_functions.ipynb): implement a custom {py:class}`AcquisitionFunction <alf_core.optimizer.acquisition_function.AcquisitionFunction>`.
