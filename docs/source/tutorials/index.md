...
- [MLIP Tutorial](https://github.com/instadeepai/alf/blob/main/tutorials/models/mlip_design_tutorial.ipynb): a machine-learned interatomic potential surrogate over atomistic systems, using a pretrained MACE model as the example and predicting per-structure energies from dict-backed structure candidates. The right choice when designing over 3D molecular or crystal structures.
