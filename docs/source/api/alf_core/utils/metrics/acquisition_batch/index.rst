...
TABULAR candidates (MOLECULE and MATERIALS are not yet supported). :func:`~alf_core.utils.metrics.acquisition_batch.compute_recall` and :func:`~alf_core.utils.metrics.acquisition_batch.compute_regret` measure
