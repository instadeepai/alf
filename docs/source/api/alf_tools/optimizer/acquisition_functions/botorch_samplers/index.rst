...
:class:`~alf_tools.optimizer.acquisition_functions.botorch_samplers.BoTorchMCSampler` is a configuration wrapper around BoTorch's Monte Carlo
...
It is not a search function: pass it to :class:`~alf_tools.optimizer.acquisition_functions.botorch_acquisition.BoTorchAcquisition` via the ``sampler``
