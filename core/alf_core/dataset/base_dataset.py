...
class BaseDataset(abc.ABC):
    ...
    def train_dataset(self) -> LabelledCandidates:
        ...
        assert "train" in self.splits, (
            ...
            "train split has not been created yet — call dataset.setup() "
            "before accessing train_dataset"
        )
    ...
    def test_dataset(self) -> LabelledCandidates:
        ...
        assert "test" in self.splits, (
            ...
            "test split has not been created yet — call dataset.setup() "
            "before accessing test_dataset"
        )
    ...
    def validation_dataset(self) -> LabelledCandidates:
        ...
        assert "validation" in self.splits, (
            ...
            "validation split has not been created yet — call dataset.setup() "
            "before accessing validation_dataset"
        )
    ...
    def candidate_pool(self) -> LabelledCandidates:
        ...
        assert "candidate_pool" in self.splits, (
            ...
            "candidate_pool split has not been created yet — call "
            "dataset.setup() before accessing candidate_pool"
        )
