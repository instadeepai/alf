...
- **UncertaintyBased** - Select the highest-variance candidates to reduce model error
  (maximum-variance / query-by-committee); requires an uncertainty-aware surrogate (ensemble or GP)
- **RandomSelection** - Uniform random baseline for comparing against informed acquisitions
